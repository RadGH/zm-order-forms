...
/**
 * @global array $atts Shortcode attributes.
...
// Custom classes from the shortcode attribute, or by the block
if ( $atts['classes'] ) {
...
?>
<div class="zm-order-form <?php echo esc_attr(implode(' ', $classes)); ?>">
	<form action="" method="POST" class="zmof-form">
		...
		<div class="zmof-section zmof-fields">
			...
			<div class="zmof-field field-name">
				<label for="zmof-name">Your Name</label>
			...
			<div class="zmof-field field-email">
				<label for="zmof-email">Your Email</label>
			...
			if ( $locations ) {
				...
				<div class="zmof-field field-location">
					<label for="zmof-location">Location</label>
